    ...
    <div ref={ref} className={`pointer-events-none relative aspect-square w-full ${className}`.trim()} aria-hidden="true">
      <motion.div className="relative h-full w-full" style={{ rotate }}>
        <svg viewBox="0 0 560 560" className="h-full w-full" fill="none">
          ...
          <circle cx="280" cy="280" r="210" className="stroke-blush-200/40" strokeWidth="1.5" />
          <circle cx="280" cy="280" r="160" className="stroke-blush-200/30" strokeWidth="1.1" />
          <ellipse cx="280" cy="280" rx="210" ry="88" className="stroke-blush-200/40" strokeWidth="1.3" />
          <ellipse cx="280" cy="280" rx="210" ry="138" className="stroke-blush-200/25" strokeWidth="1.1" />
          <ellipse cx="280" cy="280" rx="88" ry="210" className="stroke-blush-200/35" strokeWidth="1.3" />
          <ellipse cx="280" cy="280" rx="138" ry="210" className="stroke-blush-200/25" strokeWidth="1.1" />
          <path d="M70 280H490" className="stroke-blush-200/25" strokeWidth="1" />
          <path d="M110 198H450" className="stroke-blush-200/20" strokeWidth="1" />
          <path d="M110 362H450" className="stroke-blush-200/20" strokeWidth="1" />

          <g clipPath="url(#globe-clip)">
            <path
              className="fill-blush-100/20 stroke-blush-200/35"
              strokeWidth="1.2"
            ...
            />
            <path
              className="fill-blush-100/20 stroke-blush-200/30"
              strokeWidth="1"
            ...
            />
            <path
              className="fill-blush-100/20 stroke-blush-200/28"
              strokeWidth="1"
